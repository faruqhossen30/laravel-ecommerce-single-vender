                    ...
                    <div>
                        <div class="mb-3 form-floating">
                            <div class="input-group" style="margin-bottom: 25px;">
                                <input selected="" type="radio" value="21" class="charge_radio delivery_charge_id"
                                    id="ship_21" data-shippingid="21" name="shipping_method" data-shipping="60">
                                &nbsp;&nbsp;
                                <label for="ship_21" class="font-bold ">ঢাকার ভিতরে - 60৳</label>
                            </div>
                            <div class="input-group" style="margin-bottom: 25px;">
                                <input selected="" type="radio" value="22" class="charge_radio delivery_charge_id"
                                    id="ship_22" data-shippingid="22" name="shipping_method" data-shipping="120">
                                &nbsp;&nbsp;
                    ...
                    <div class="grid grid-cols-5 p-4">
                        <div class="col-span-3 ">
                            <div class="p-3 border border-gray-300">
                                ...
                                <a href="#" class="px-2 py-1 text-sm text-white bg-green-600 rounded-md">Login</a>
                            </div>
                        </div>
                        <div class="col-span-2 ">
                            <div class="p-3 border border-gray-300">
                                <a href="#" class="px-2 py-1 text-white bg-blue-600 rounded-md">কূপন থাকলে এপ্লাই করুন</a>
                            </div>
                        </div>
                    </div>
