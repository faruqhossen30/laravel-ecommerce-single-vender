        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="{{ route('dashboard') }}" class="flex items-center ml-2 md:mr-24">
                    <img src="{{ asset('logo.png') }}" class="h-12 mr-3" alt="Comment Jet" />
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-gray-500 dark:text-gray-200 uppercase">E-Commerce</span>
                </a>
