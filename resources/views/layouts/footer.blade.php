<section class="bg-green-500">
    <div class="container p-4 mx-auto mt-12 ">
        <div class="grid grid-cols-12 gap-6 lg:gap-4">
            <div class="col-span-12 space-y-2 lg:space-y-0 lg:col-span-4 lg:border-r lg:rounded">
                ...
                <div class="flex space-x-4 text-white">
                    ...
                    <p class="pl-20 text-sm lg:pl-4 ">2nd Floor, House#17, Road # 1, Mohammadia Housing society</p>
                </div>
                <div class="flex items-center space-x-4 text-white">
                    ...
                    <p class="pl-20 text-sm lg:pl-4 ">01615597820</p>
                </div>
                <div class="flex items-center space-x-4 text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                        <path
                    ...
                    <p class="pl-20 text-sm lg:pl-4 ">softitglobal@gmail.com</p>
                </div>
            </div>
            <div class="col-span-12 space-y-1 text-white lg:space-y-0 lg:col-span-2 lg:border-r lg:rounded-r">
            ...
            <div class="col-span-12 pr-2 space-y-2 text-white lg:space-y-0 lg:col-span-3 lg:border-r lg:rounded-r">
            ...
            <div class="col-span-12 space-y-2 text-white lg:space-y-0 lg:col-span-3">
